...
class TransformerEncoderLayer(nn.Module):
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    # For Hie
    def build_self_attention(self, embed_dim, args):
        #half_heads = args.encoder_attention_heads // 2
        heads = args.encoder_attention_heads
        join_head = args.encoder_attention_join_head
        return MultiheadAttention(
            embed_dim,
            heads,
            dropout=args.attention_dropout,
    ...
    def forward(self, x, encoder_padding_mask, attn_mask: Optional[Tensor] = None, segments = None, src = None):
        """
        Args:
